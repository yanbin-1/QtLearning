...
QT_MOC_LITERAL(1, 10, 25), // "on_actSetHeader_triggered"
QT_MOC_LITERAL(2, 36, 0) // ""

    },
    "FormTable\0on_actSetHeader_triggered\0"
    ""
};
...
void FormTable::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        FormTable *_t = static_cast<FormTable *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_actSetHeader_triggered(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject FormTable::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_FormTable.data,
      qt_meta_data_FormTable,  qt_static_metacall, nullptr, nullptr}
};
...
void *FormTable::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FormTable.stringdata0))
        return static_cast<void*>(const_cast< FormTable*>(this));
